---
title: Skills Registry Exploration (Archived)
...
> **ARCHIVED:** This document is a historical design spec superseded by the global skills migration (epic `xtrm-bq7yd`, Batches A–F). The three-tier model described here was implemented and evolved into the global + project layered model. See [docs/plans/global-skills-migration.md](plans/global-skills-migration.md) for the current architecture and operator workflow. Kept for context only.
