...
title: Untitled
date_created: Sunday, February 8th 2026, 12:02:21 pm
date_modified: Sunday, February 8th 2026, 12:02:34 pm
---
scope: reference
category: reference
version: 1.0.0
...
| Section | Summary |
|---|---|
| [Getting started](#getting-started) | This example creates a skill that teaches Claude to explain code using visual diagrams and analogies |
| [Configure skills](#configure-skills) | Skills are configured through YAML frontmatter at the top of `SKILL |
| [Additional resources](#additional-resources) | scope: reference |
| [Advanced patterns](#advanced-patterns) | The `!`command\`\` syntax runs shell commands before the skill content is sent to Claude |
| [Pull request context](#pull-request-context) | Summarize this pull request |
| [Your task](#your-task) | Summarize this pull request |
| [Share skills](#share-skills) | Skills can be distributed at different scopes depending on your audience: |
| [Usage](#usage) | Run the visualization script from your project root: |
| [What the visualization shows](#what-the-visualization-shows) | """Generate an interactive collapsible tree visualization of a codebase |
| [Troubleshooting](#troubleshooting) | If Claude doesn't use your skill when expected: |
| [Related resources](#related-resources) | * **[Subagents](/en/sub-agents)**: delegate tasks to specialized agents |
<!-- END INDEX -->
> ## Documentation Index
