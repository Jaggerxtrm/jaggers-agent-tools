...
| Section | Summary |
|---|---|
| [Create your first Skill](#create-your-first-skill) | This example creates a personal Skill that teaches Claude to explain code using visual diagrams and analogies |
| [How Skills work](#how-skills-work) | Skills are **model-invoked**: Claude decides which Skills to use based on your request |
| [Configure Skills](#configure-skills) | This section covers Skill file structure, supporting files, tool restrictions, and distribution options |
| [Instructions](#instructions) | Provide clear, step-by-step guidance for Claude |
| [Examples](#examples) | Show concrete examples of using this Skill |
| [Overview](#overview) | [Essential instructions here] |
| [Additional resources](#additional-resources) | To validate input files, run the helper script |
| [Utility scripts](#utility-scripts) | To validate input files, run the helper script |
| [Examples](#examples) | These examples show common Skill patterns, from minimal single-file Skills to multi-file Skills with supporting document |
| [Instructions](#instructions) | 1 |
| [Best practices](#best-practices) | pdf-processing/ |
| [Quick start](#quick-start) | Extract text: |
| [Requirements](#requirements) | Packages must be installed in your environment: |
| [Troubleshooting](#troubleshooting) | To see which Skills Claude has access to, ask Claude a question like "What Skills are available?" Claude loads all avail |
| [Next steps](#next-steps) | <CardGroup cols={2}> |
<!-- END INDEX -->
# Agent Skills
