...
| Section | Summary |
|---|---|
| [Overview](#overview) | The `orchestrating-agents` skill enables deep collaboration between the primary agent and neighboring CLI agents (Gemini |
| [Key Components](#key-components) | Defines the headless command structure for each agent: |
| [Integration Patterns](#integration-patterns) | The skill utilizes the `AgentContext` pattern (defined in `hooks/agent_context |
