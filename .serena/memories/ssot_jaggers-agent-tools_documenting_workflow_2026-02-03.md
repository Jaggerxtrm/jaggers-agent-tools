...
| Section | Summary |
|---|---|
| [Overview](#overview) | This document defines the mandatory process for updating documentation within the `jaggers-agent-tools` project |
| [Core Documentation Artifacts](#core-documentation-artifacts) | The project supports direct execution via `npx` without the need to clone the repository manually |
| [Installation & Distribution](#installation-&-distribution) | The project supports direct execution via `npx` without the need to clone the repository manually |
| [Update Workflow](#update-workflow) | The primary tool for documenting changes is the **Documenting Orchestrator** |
| [Standards & Quality](#standards-&-quality) | _no summary_ |
