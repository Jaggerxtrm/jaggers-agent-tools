...
### Changed
- xtrm-ui now owns XTRM-named themes and one native/external tool renderer; retired footer, external compaction, and box-chrome preferences/commands, with legacy Pi theme migration.
